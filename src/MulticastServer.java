        ...
        if (indexes_and_references_to_send_or_add.length != 0) {
          ...
          while (i.hasNext()) {
            ...
            MessageByTCP messageToTCP =
                new MessageByTCP("UPDATE", aux, references, index, descriptionTitle);
...
class HandleRequest extends Thread {
  ...
  private String protocolReaderMulticastSide(String sms) throws InterruptedException {
    ...
    HashMap<String, ArrayList<String>> descriptionTitle =
        this.filesManager.loadDataBaseDescriptions();
    ...
    if (myDic.get("ACK") != null) {
      // Quando recebe um ack, significa que a sua resposta chegou e que pode elimina-la da tabela
      // de mensagens
      ...
      switch ((String) myDic.get("type")) {
        case "requestURLbyWord":
          ...
          for (int i = 0; i < urls.length; i++) {
            ...
            messageToRMI +=
                "url_" + (i + 1) + "|" + urls[i] + "*oo#&" + title + "*oo#&" + description + ";";
          }
          synchronized (responsesTable) {
          ...
          if (referencesFound == null) {
            ...
            for (String elem : referencesFound) {
              ...
              if (description_title != null) {
                ...
                System.out.println(
                    "DESCRIPTION_TITLE_ARRAY===" + Arrays.toString(description_title.toArray()));
                description = (String) description_title.toArray()[1];
                description = description.replace(";", ",");
                title = (String) description_title.toArray()[0];
                title = title.replace(";", ",");
              ...
              messageToRMI +=
                  "url_" + k + "|" + elem + "*oo#&" + title + "*oo#&" + description + ";";
        ...
        case "requestUSERFbAssociation":
          ...
          for (int i = 0; i < users.size(); i++) {
            if (users.get(i).getUsername().equals((String) myDic.get("user"))) {
              myUser = users.get(i);
              myUser.setUsernameFb(myDic.get("userFb"));
              myUser.setPasswordFb(myDic.get("passFb"));
              users.remove(i);
              users.add(myUser);
              bd = new DatabaseHandler(users, filesManager);
              bd.start();
              System.out.println("\n\n\n\n\n\n------------------------------------------------------\n\n\n\n\n"+ myUser+"\n\n\n\n----------------------------------------------------");
              message2send = "association|" + "success;";
              synchronized (responsesTable) {
                responsesTable.put(
                    myDic.get("idRMI"),
                    "id|"
                        + (String) myDic.get("idRMI")
                        + ";type|responsetUSERFbAssociation;"
                        + message2send);
              }
              return "id|"
                  + (String) myDic.get("idRMI")
          ...
          synchronized (responsesTable) {
            responsesTable.put(
                myDic.get("idRMI"),
                "id|" + (String) myDic.get("idRMI") + ";type|responsetUSERFbAssociation;");
          }
          return "id|" + (String) myDic.get("idRMI") + ";type|responsetUSERFbAssociation;";
        ...
        case "requestUSERLogin":
           ...
           * */
          users = filesManager.loadUsersFromDataBase();
          System.out.println("\n\n\n\n\n\n\n\n\n\n\n________________________________________________"+users+"\n\n\n\n\n\n\n__________________________________________________________");
          for (int i = 0; i < users.size(); i++) {
            System.out.println("MYDICT===" + myDic);
            System.out.println("USER===" + users.get(i));
            if ((users.get(i).getUsername().equals((String) myDic.get("user"))
                    && users.get(i).getPassword().equals((String) myDic.get("pass")))
                || (users.get(i).getUsernameFb().equals((String) myDic.get("user"))
                    && users.get(i).getPasswordFb().equals((String) myDic.get("pass")))) {
              System.out.println("USER===2" + users.get(i));
              if (users.get(i).getIsAdmin()) {
                if (users.get(i).getNotify()) {
                  users.get(i).setNotify(false);
                  synchronized (responsesTable) {
                    if (!users.get(i).getUsernameFb().equals("")) {
                      responsesTable.put(
                          myDic.get("idRMI"),
                          "id|"
                              + (String) myDic.get("idRMI")
                              + ";type|responseUSERLogin;status|logged admin;Notify|true;Fb|true");
                    } else {
                      responsesTable.put(
                          myDic.get("idRMI"),
                          "id|"
                              + (String) myDic.get("idRMI")
                              + ";type|responseUSERLogin;status|logged admin;Notify|true;Fb|false");
                    }
                  }
                  if (!users.get(i).getUsernameFb().equals("")) {
                    return "id|"
                ...
                synchronized (responsesTable) {
                  if (!users.get(i).getUsernameFb().equals("")) {
                    responsesTable.put(
                        ...
                        "id|"
                            + (String) myDic.get("idRMI")
                            + ";type|responseUSERLogin;status|logged admin;Notify|false;Fb|true");
                  } else {
                    responsesTable.put(
                        myDic.get("idRMI"),
                        "id|"
                            + (String) myDic.get("idRMI")
                            + ";type|responseUSERLogin;status|logged admin;Notify|false;Fb|false");
                  }
                }
                if (!users.get(i).getUsernameFb().equals("")) {
                  return "id|"
                      + (String) myDic.get("idRMI")
                      + ";type|responseUSERLogin;status|logged admin;Notify|nop;Fb|true";
                } else {
                  return "id|"
                      + (String) myDic.get("idRMI")
                      + ";type|responseUSERLogin;status|logged admin;Notify|nop;Fb|false";
                }
              }
              synchronized (responsesTable) {
                if (!users.get(i).getUsernameFb().equals("")) {
                  ...
                  responsesTable.put(
                      ...
                      "id|"
                          + (String) myDic.get("idRMI")
                          + ";type|responseUSERLogin;status|logged on;Fb|true");
                } else {
                  responsesTable.put(
                      myDic.get("idRMI"),
                      "id|"
                          + (String) myDic.get("idRMI")
                          + ";type|responseUSERLogin;status|logged on;Fb|false");
                }
              }
              if (!users.get(i).getUsernameFb().equals("")) {
                System.out.println("WTF222222!!!!");
                return "id|"
                    + (String) myDic.get("idRMI")
                    + ";type|responseUSERLogin;status|logged on;Notify|nop;Fb|true";
              } else {
                System.out.println("FDSDSDSDSDSDSSDSDSD PQ");
                return "id|"
                    + (String) myDic.get("idRMI")
                    + ";type|responseUSERLogin;status|logged on;Notify|nop;Fb|false";
              }
            }
            }
        ...
        case "requestUSERFbRegist":
          System.out.println("OLEOLEOLEOELOEL");
          /*
           * Muito semelhante ao anterior, uma vez que percorre a base de dados a procura de um utilizador um o mesmo user name de facebook
           * caso nao encontre, adiciona-o a base de dados
           * se o encontra informa o servidor RMI para informar o end-user que ja existe um utilizador com esse username
           *
           * Confirma tambem se a base de dados esta vazia, uma vez que se isto se verificar, significa que esse utilizador
          ...
          if (users.isEmpty()) {
            User adminUser =
                new User((String) myDic.get("userFb"), (String) myDic.get("passFb"), true);
            adminUser.setIsAdmin();
            users.add(adminUser);
            bd = new DatabaseHandler(users, filesManager);
            bd.start();
            synchronized (responsesTable) {
              responsesTable.put(
                  myDic.get("idRMI"),
                  "id|" + (String) myDic.get("idRMI") + ";type|responseUSERFbRegist;status|Admin");
            }
            return "id|" + (String) myDic.get("idRMI") + ";type|responseUSERFbRegist;status|Admin";
          }
          for (int i = 0; i < users.size(); i++) {
            if (users.get(i).getUsernameFb().equals((String) myDic.get("userFb"))) {
              synchronized (responsesTable) {
                responsesTable.put(
                    myDic.get("idRMI"),
                    "id|"
                        + (String) myDic.get("idRMI")
                        + ";type|responseUSERFbRegist;status|Failled");
              }
              return "id|"
                  + (String) myDic.get("idRMI")
                  + ";type|responseUSERFbRegist;status|Failled";
          ...
          users.add(new User((String) myDic.get("userFb"), (String) myDic.get("passFb"), true));
          bd = new DatabaseHandler(users, filesManager);
          bd.start();
          synchronized (responsesTable) {
            responsesTable.put(
                myDic.get("idRMI"),
                "id|" + (String) myDic.get("idRMI") + ";type|responseUSERFbRegist;status|Success");
          }
          return "id|" + (String) myDic.get("idRMI") + ";type|responseUSERFbRegist;status|Success";
  ...
  public HashMap[] crawl(String url) {
    ...
    try {
      ...
      database_changes_and_references_to_index[2] =
          indexDescriptionsAndTitles(description, title, inputLink, descriptionTitle);

      System.out.println("------DESCRIPTION------");
      System.out.println(database_changes_and_references_to_index[2]);
      System.out.println("ULR SAVED ---->" + url);
      DatabaseHandler handler_db =
          new DatabaseHandler(refereceURL, indexURL, descriptionTitle, filesManager);
      handler_db.start();
  ...
  public HashMap<String, ArrayList<String>> indexDescriptionsAndTitles(
      String description,
      String title,
      String inputLink,
      HashMap<String, ArrayList<String>> descriptionTitle) {
