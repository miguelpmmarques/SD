...
public class MulticastServer extends Thread {
    ...
    Comunication2 com = new Comunication2();
...
class QueueProcessor extends HandleRequest {
    public QueueProcessor(MulticastServer parent_thread, String message, Comunication2 com) {
...
class HandleRequest extends Thread {
    ...
    public HandleRequest(MulticastServer parent_thread, String message, Comunication2 com) {
        super();
    ...
    public void run() {
        ...
        sendMulticastMessage(this.request);
        /*try {
            interpretRequest();
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public void sendMulticastMessage(String message) {
        ...
        try {
            ...
            String messageToRMI = protocolReaderMulticastSide(message);
            System.out.println(messageToRMI);
            byte[] buffer = messageToRMI.getBytes();
            InetAddress group = InetAddress.getByName(MULTICAST_ADDRESS);
    ...
    private String protocolReaderMulticastSide(String sms){
        ...
        System.out.println(myDic.get("type"));
        switch ((String)myDic.get("type")) {
            ...
            case "requestUSERLogin":
                ...
                for (int i = 0; i < usersL.size(); i++) {
                    if (usersL.get(i).username.equals((String)myDic.get("user")))
                    {
                        if (usersL.get(i).getIsAdmin()){
                            return "type|responseUSERLogin;status|logged admin";
                        }
                        return "type|responseUSERLogin;status|logged on";
                    }
                }

                return "type|responseUSERLogin;status|logged off;";
            case "requestUSERRegist":
                ...
                DatabaseHandler bd = new DatabaseHandler(usersR);
                bd.start();
                return "type|responseUSERRegist;status|Success";
            case "requestAllUSERSPrivileges":
                ...
                String messageToSend = "type|responseUSERSPrivileges;user_count|"+usersS.size()+";";
    ...
    public void interpretRequest() throws InterruptedException {
        ...
        String messageToRMI = protocolReaderMulticastSide(request);
        System.out.println(messageToRMI);
